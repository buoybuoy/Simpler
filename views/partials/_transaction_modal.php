<div class="modal fade" id="transactionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form data-modal="#transactionModal" action="<?php echo $action_page; ?>" method="post" autocomplete="off" class="form ajax-form" id="transactionForm">
				<input type="hidden" name="action" value="update_transaction">
				<input type="hidden" name="id" id="transactionId" value="placeholder">
				<input type="hidden" name="budget_year" value="<?php echo $year; ?>">
						...
						<div class="col-xs-5">
							<fieldset class="form-group">
								<select class="form-control" id="budget_categories" name="budget_category_id">
									<?php foreach($budgeted_amounts as $id => $budgeted_amount) {
						...
						<div class="col-xs-7">
							<div class="btn-group" data-toggle="buttons">
								...
								<label class="btn btn-default active">
									<input type="radio" name="budget_month" id="inlineRadio1" value="<?php echo $month; ?>" checked> This Month
								</label>
								<label class="btn btn-default">
